...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    price: "$1,099",
    description:
      "Far infrared therapy mat with 25 pounds of amethyst and ten PEMF cores running 3\u201323 Hz. The 6\u201314 micron wavelengths penetrate deep into pelvic tissue, increasing circulation and bringing down the inflammatory load that drives endo pain. The PEMF frequencies support cellular repair and a parasympathetic shift, which is the work of nervous system regulation that has to happen alongside everything else. Negative ion output for cellular detox.",
    shortDescription: "PEMF + far infrared mat with customizable frequency levels.",
    personalNote: "I use levels 1 & 2 daily with negative ion turned on and infrared heat on for pain relief, relaxation, and nervous system regulation. This has been one of the most effective tools for me and the science is impossible to ignore.\nx, N",
  ...
  },
  {
    ...
    price: "$699",
    description:
      "Dual wavelength red (650nm) and near-infrared (850nm) light therapy. Through a process called photobiomodulation, these wavelengths feed energy into the mitochondria of the cells they reach, which is the work of giving tissue the resources to actually repair itself. Red light supports the surface layers. Near-infrared penetrates further into muscle and connective tissue, lowering local inflammation and improving circulation through the lower abdominal wall and pelvic floor, the regions that hold so much of the chronic guarding and inflammatory load of endo. There\u2019s also a well-documented analgesic effect, which matters when you\u2019re working with a body that has been in pain for years. Comes with stand, goggles, and dust bag.",
    shortDescription: "Targeted red light therapy tower with variable optics.",
    personalNote: "I use it on my lower abdomen daily, ten to twenty minutes, often stacked with the Clearlight PEMF mat.\nx, N",
